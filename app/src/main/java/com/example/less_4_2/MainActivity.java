...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText departure_pointIn; // поле адреса
    ...
    private String departure_point; // поле хранения адреса
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        departure_pointIn = findViewById(R.id.departure_pointIn);
        emailIn = findViewById(R.id.place_arrivalIn);
